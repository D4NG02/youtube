        ...
        <div className="flex flex-col gap-5 text-sm">
            ...
            <div>
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex flex-row gap-4"><Icon src={IconGlobe} /><span>{'www.youtube.com/' + channel.url}</span></div>
                    <div className="flex flex-row gap-4"><Icon src={IconSubscriber} /><span>{channel.subscriberCount} subscribers</span></div>
                    <div className="flex flex-row gap-4"><Icon src={IconVideo} /><span>{channel.videoCount} videos</span></div>
                    <div className="flex flex-row gap-4"><Icon src={IconStatistic} /><span>{channel.viewCount} views</span></div>
